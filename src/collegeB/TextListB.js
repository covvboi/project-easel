...
// import ImgCompo from '../component1/ImgCompo'
import '../App.css';

const TextListB = ({textb}) => {
...
let { id } = useParams();
  return (
    <div className="main-text">
        ...
        <hr />
        <Form className="d-flex" action='/comment2' method="POST">
        ...
        <Link to={`/commentview2/${textlist._id}`}> 
